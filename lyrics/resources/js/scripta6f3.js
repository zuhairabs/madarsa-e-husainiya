...
myApp.onPageInit('nauha', function (page) {
	...
	$$.ajax({
			url : "https://m.nauhalyricsapp.in/apiv1_2.php?q=nauhakhwan&type=Nauha&format=json",
			timeout : 30000,
			success : function(data) {
...
myApp.onPageInit('manqabat', function () {
	...
	$$.ajax({
			url : "https://m.nauhalyricsapp.in/apiv1_2.php?q=nauhakhwan&type=Manqabat&format=json",
			timeout : 30000,
			success : function(data) {
...
myApp.onPageInit('marsiya', function () {
	...
	$$.ajax({
			url : "https://m.nauhalyricsapp.in/apiv1_2.php?q=nauhakhwan&type=Marsiya&format=json",
			timeout : 30000,
			success : function(data) {
...
myApp.onPageInit('album', function (page) {
	...
	$$.ajax({
			url : "https://m.nauhalyricsapp.in/apiv1_2.php?q=year&type="+params.type+"&id="+params.id+"&format=json",
			timeout : 30000,
			success : function(data) {
...
myApp.onPageInit('list', function (page) {
	...
	$$.ajax({
			url : "https://m.nauhalyricsapp.in/apiv1_2.php?q=list&type="+params.type+"&id="+params.id+"&year="+params.year+"&format=json",
			timeout : 60000,
			success : function(data) {
...
myApp.onPageInit('lyrics', function (page) {
	...
	$$.ajax({
			url : "https://m.nauhalyricsapp.in/apiv1_2.php?q=lyric&id="+params.id,
			timeout : 30000,
...
myApp.onPageInit('search', function (page) {
	...
	$$.ajax({
		url : "https://m.nauhalyricsapp.in/apiv1_2.php?q=searchcount&term="+params.keyword,
		timeout : 60000,
		success : function(response) {
	...
	$$.ajax({
		url : "https://m.nauhalyricsapp.in/apiv1_2.php?q=search&format=json&term="+params.keyword,
		timeout : 30000,
		success : function(data) {
			var response = JSON.parse(data);
			if(!response.error){
